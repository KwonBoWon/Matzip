...
public class ReviewUploadManager : MonoBehaviour
{
    ...
    void SaveToJson()
    {
        ...
        data["shop_name"] = mainManager.shopName;
        data["user_name"] = mainManager.userName;
        //data["star_rating"] = rating;

        string jsonString = data.ToString();
        System.IO.File.WriteAllText(Path.Combine(Application.dataPath, "reviewData.json"), jsonString);

        //Debug.Log("Data saved to " + Application.DataPath + "/"+  +".json");
